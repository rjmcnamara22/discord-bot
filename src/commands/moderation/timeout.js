...
module.exports = {
  ...
  callback: async (client, interaction) => {
    ...
    if (targetUserRolePosition >= requestUserRolePosition) {
      await interaction.editReply(
        "You can't time out that user because they have the same/higher role than you."
      );
      return;
    }
    ...
    if (targetUserRolePosition >= botRolePosition) {
      await interaction.editReply(
        "I can't time out that user because they have the same/higher role than me."
      );
      return;
    }
  ...
  options: [
    ...
    {
      name: "reason",
      description: "The reason for user timeout.",
      type: ApplicationCommandOptionType.String,
    },
  ],
